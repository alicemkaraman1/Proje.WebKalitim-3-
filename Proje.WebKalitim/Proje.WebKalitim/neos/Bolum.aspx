<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bolum.aspx.cs" EnableEventValidation="false" Inherits="Proje.WebKalitim.neos.Bolum" %>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4 border-right" data-aos="fade-up" data-aos-delay="100">
            <div class="text-center">
              <span class="flaticon-bar-chart display-4 d-block mb-3 text-primary"></span>
                <h3 class="text-uppercase h4 mb-3">
             <asp:DropDownList ID="drp_okul" runat="server">
                 <asp:ListItem Selected="True" Value="-1">Okul Seçiniz</asp:ListItem>
                    </asp:DropDownList></h3>
              <h3 class="text-uppercase h4 mb-3"><asp:TextBox ID="txt_okulad" placeholder="Bolum Adı Giriniz" runat="server"></asp:TextBox></h3>
              <h3 class="text-uppercase h4 mb-3"><asp:TextBox ID="txt_okuladres" placeholder="Bolum Adresi Giriniz" runat="server"></asp:TextBox></h3>
                <h3 class="text-uppercase h4 mb-3"><asp:TextBox ID="txt_okultel" placeholder="Bolum Telini Giriniz" runat="server"></asp:TextBox></h3>
                <h3 class="text-uppercase h4 mb-3"><asp:TextBox ID="txt_okulkodu" placeholder="Bolum Kodunu Giriniz" runat="server"></asp:TextBox></h3>
             <h3 class="text-uppercase h4 mb-3"><asp:Button ID="Button2" runat="server" CssClass="btn btn-bg-primary" BackColor="Black" Text="Bolum Bilgisi Ekle" OnClick="Button2_Click" /></h3>
